...
var PicListInit = {
    "init": function () {
        $(".c_pictures_1").getPictureListByGroup();
        initImgdrag();
        initDeleteImg();
        initSave();
    },

    "HANDLE":"Handle/MustGripPictureHandle.ashx",
    "PICTUREHANDLE": "Handle/UploadHandle.ashx",
    ...
    "extJq":function() {
        ...
        $.fn.getPictureListByGroup = function () {
            var self = $(this);
            self.empty();
            var type = $("#hidGroup").val();
            var data = {
                f: "getPictureListByGroup",
                data: group
            };
            $.ajax({
                url: HANDLE,
